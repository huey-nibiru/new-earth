...
const Defense = () => {
  ...
  const POST_SCHEMA = "defense_and_safety"; // Change this to your desired schema
  ...
  return (
    <div>
      <div className="header">
        <h1>Defense & Safety</h1>
        <p>
          Self Defense and training. Use this space to share your defense experiences with others and learn from others.
          ...
          resources and other defense materials with others.
        </p>
      </div>
