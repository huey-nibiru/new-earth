...
const Technology = () => {
  ...
  const POST_SCHEMA = "technology_and_innovation"; // Change this to your desired schema
  ...
  return (
    <div>
      <div className="header">
        ...
        <p>
          Tech news, engineering, collaboration. Use this space to share your technology experiences with others and learn from others.
          ...
          resources and other technology materials with others.
        </p>
      </div>
