...
const Governance = () => {
  ...
  const POST_SCHEMA = "governance_and_justice"; // Change this to your desired schema
  ...
  return (
    <div>
      <div className="header">
        <h1>Governance & Justice</h1>
        <p>
          Governance and legal information. Use this space to share your governance experiences with others and learn from others.
          ...
          resources and other governance materials with others.
        </p>
      </div>
