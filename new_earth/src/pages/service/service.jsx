...
const Service = () => {
  ...
  const POST_SCHEMA = "service_and_charity"; // Change this to your desired schema
  ...
  return (
    <div>
      <div className="header">
        <h1>Service & Charity</h1>
        <p>
          Post available services and charitable work. Use this space to share your service experiences with others and learn from others.
          ...
          resources and other service materials with others.
        </p>
      </div>
